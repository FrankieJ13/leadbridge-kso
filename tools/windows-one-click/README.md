...
Внутрь установщика входят LeadBridge Web, MAX exporter, OCR postprocessor, Python 3.12.10, Pillow 12.3.0, Tesseract 5.5.3 и модели `rus+eng`. После скачивания EXE интернет для установки не требуется.
