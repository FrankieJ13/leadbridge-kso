...
Если архив уже скачан, нажмите в расширении «Выбрать ZIP для OCR» и укажите `MAX_CHAT_EXPORT_...zip` в окне Chrome. Повторно сканировать чат не требуется. После проверки локальной OCR-службы Chrome сохранит рабочую копию файла и запустит её обработку; исходный архив не изменяется и никуда не отправляется.
